<ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
    ...
    <li class="nav-item">
        <a class="nav-link" id="localisation-tab" data-toggle="tab" href="#localisation" role="tab" aria-controls="localisation" aria-selected="false">{{ __('Localisation') }}</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" id="mail-tab" data-toggle="tab" href="#mail" role="tab" aria-controls="mail" aria-selected="false">{{ __('Mail') }}</a>
    </li>
    <li class="nav-item">
